...
if(isset($_POST['email'])) {
    ...
    $email_to = "franciscoalanzavesromero@gmail.com";
...
<div class="container">
  <div class="row">
    ...
    <div class="col">
    <h3>Gracias por contactar conmigo!!!
       Te contesto a la mayor brevedad posible.
       Fco Alanzaves.</h3>
    </div>
    <div class="col">
     <a target="blank" href="index.html"> <button type="button" class="btn btn-success">Volver</button></a>
    </div>
  </div>
</div>
</html>
